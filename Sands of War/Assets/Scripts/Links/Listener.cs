...
namespace AssemblyCSharp
{
	...
	{						
        ...
        public delegate void UserLeftRoomHandler(RoomData eventObj, string _UserName);
        public static event UserLeftRoomHandler onUserLeftedRoom;


        public delegate void UserLeaveRoomDoneHandler(bool _IsSuccess, string _RoomId);
        public static event UserLeaveRoomDoneHandler OnLeaveRoom;
		...
		public void onLeaveRoomDone (RoomEvent eventObj)
		{
			...
			if (eventObj.getResult() == 0 && OnLeaveRoom != null)
				OnLeaveRoom(true, eventObj.getData().getId());
			else if (eventObj.getResult() == 0 && OnLeaveRoom != null)
				OnLeaveRoom(false, string.Empty);
        }
		...
		public void onUserLeftRoom (RoomData eventObj, string username)
		{
            ...
            if (onUserLeftedRoom != null)
                onUserLeftedRoom(eventObj, username);		
        }
